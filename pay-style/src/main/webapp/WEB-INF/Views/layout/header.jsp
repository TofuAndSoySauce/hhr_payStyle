  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="/auth/board">게시판</a>
        </li>
      </ul>
      
    <c:if test="${empty principal}">
      <form class="d-flex" role="login" action="/auth/loginProc" method="POST">
        <input class="form-control me-2" type="text" placeholder="아이디"  id="userid" name="userid" required>
        <input class="form-control me-2" type="password" placeholder="비밀번호" id="password" name="password" required>
        <button class="btn btn-outline-success" type="submit" style="margin-right:10px;" onkeyup="login_check()" onclick="login_check()">login</button>
      </form>
